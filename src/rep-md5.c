...
digest_to_repv(char digest[16])
{
  ...
  /* Currently rep has no interface to create bignums directly, so
     format to a hex-encoded string, then reparse it.

     FIXME: This loses if rep was compiled without GMP support.. */
